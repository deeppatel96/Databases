...
<%
	...
	List<String> list = new ArrayList<String>();
		...
		try {
			...
			if(!first.equals("") && !last.equals("")){
				str = "SELECT * FROM Leg L, Reservation R, Account A, Customer C, Person P WHERE C.ID_No = P.ID_No AND A.ID_No = C.ID_No AND R.Account_No = A.Account_No AND P.First_Name = '" + first + "' AND P.Last_Name = '" + last + "' GROUP BY C.ID_No";
				...
				rev = "SELECT SUM(Booking_Fee) FROM Leg L, Reservation R, Account A, Customer C, Person P WHERE C.ID_No = P.ID_No AND A.ID_No = C.ID_No AND R.Account_No = A.Account_No AND P.First_Name = '" + first + "' GROUP BY C.ID_No";
			}else{
				...
				rev = "SELECT SUM(Booking_Fee) FROM Leg L, Reservation R, Account A, Customer C, Person P WHERE C.ID_No = P.ID_No AND A.ID_No = C.ID_No AND R.Account_No = A.Account_No AND P.Last_Name = '" + last + "' GROUP BY C.ID_No";
			}
			...
			if (!result.next() ) {
					...
					while (true) {
						...
						r = r + Double.parseDouble(result.getString("Booking_Fee"));
						out.print("</td>");
						out.print("</tr>");
						if(!result.next()){
							break;
