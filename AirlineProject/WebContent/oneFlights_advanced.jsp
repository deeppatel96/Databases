...
<br>	
	...
	try {
		...
		//String str = "SELECT * FROM Flight WHERE Flight_No = (SELECT Flight_Number FROM Leg GROUP BY Flight_Number ORDER BY count(*) DESC LIMIT 1) AND depAirID ='" + origin +"' AND arrAirID ='"+destination+"' AND depDate >='"+departDate+"'" ;
...
<!-- 	<form method="post" action="fly1.jsp">
	...
	<form method="post" action="res6.jsp">
