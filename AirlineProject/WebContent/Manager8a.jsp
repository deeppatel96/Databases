...
<title>Customers with Reserved Flight Seats</title>
</head>
<body>
<%
	...
	List<String> list = new ArrayList<String>();
		...
		try {
			...
			str = "SELECT * FROM Passenger Pa, Leg L, Reservation R, Flight F, Customer C, Account A, Person P WHERE Pa.resNo = R.Res_No AND C.ID_No = A.ID_No AND C.ID_No = P.ID_No AND R.Account_No = A.Account_No AND L.Res_No = R.Res_No AND L.Airline_ID = '"+ airline + "' AND L.Flight_Number = '"+fno+"' AND L.Departure_Date_Time LIKE	 '" + date + "%' GROUP BY C.ID_No";						
