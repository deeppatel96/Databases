...
<title>Customer Rep makes Reservation</title>
</head>
<body>
    <div align="left">
    ...
    <div>
    <a href="CustomerRep1.jsp">Back</a>
    </div>
    <br>	
<%
	try{
...
// ===========================================================
		...
		out.println(" Departing from: "+ depAirID+ " at "+depTime+" | ");	
		out.println(" Arriving at: "+ arrAirID+ " at "+arrTime+" | ");	
		out.println("");
