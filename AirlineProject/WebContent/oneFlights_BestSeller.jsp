...
<br>	
	...
	try {
		...
		String origin = request.getParameter("originB");
		String destination = request.getParameter("destinationB");
		String departDate = request.getParameter("departDateB");

		String str = "SELECT * FROM Flight WHERE Flight_No = (SELECT Flight_Number FROM Leg where From_Airport_ID ='"+ origin+"' AND To_Airport_ID ='"+destination+"' GROUP BY Flight_Number ORDER BY count(*) DESC LIMIT 1) AND depAirID ='" + origin +"' AND arrAirID ='"+destination+"' AND depDate ='"+departDate+"'" ;
...
<!-- 	<form method="post" action="fly1.jsp">
	...
	<form method="post" action="res_flexiable.jsp">
